...
const About = () => {
  return (
    <section className="text-white py-16 px-6">
      <Helmet>
        <title>About Kerliix Technologies.</title>
        <meta
          name="description"
          content="Learn about Kerliix Technologies, our mission to unify digital experiences, and how we connect people with the technologies the use seamlessly. Discover our vision, team, and developer tools."
        />
        <meta
          name="keywords"
          content="Kerliix, kerliix technologies, Kerliix technologies Limited, technology, digital experiences, developer tools, connected devices, APIs, SDKs, tech innovation"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Learn about Kerliix Technologies, our mission to unify digital experiences, and how we connect people with the technologies the use seamlessly. Discover our vision, team, and developer tools."
          })}
        </script>
      </Helmet>
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        {/* Image 1 - plain */}
        <img
          src="https://kerliix.com/assets/kerliix-logo.png"
          alt="Kerliix logo"
        ...
        <div className="space-y-6 text-gray-300 text-lg">
          ...
          {/* Image 2 - plain */}
          <img
            src="https://kerliix.com/assets/kerliix-icon.png"
          ...
          {/* Image 3 - plain */}
          <img
            src="https://kerliix.com/assets/about-team.jpg"
